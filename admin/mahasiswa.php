<?php
$con1 = mysqli_connect("localhost", "root", "","kipkrpl");
            ...
            <form class="form-horizontal" method="post">
               <input type="hidden" name="id" value="<?php echo isset($data[0])?$data[0]:''; ?>">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="dua" class="col-sm-2 control-label">No Kartu Kip</label>
                        <div class="col-sm-4">
                                <textarea name="tempatkp" class="form-control" rows="2"><?php echo isset($data[5])?$data[5]:''; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="tiga" class="col-sm-2 control-label">Tanggal Pengajuan </label>
                        <div class="col-sm-2" >
