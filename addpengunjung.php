...
<br>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Silahkan Isi Data Mahasiswa KIP-K 2020</div>
                <div class="panel-body">
                    <form method="post" action="" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="col-md-offset-1 control-label col-md-3" for="email">No KIP-K</label>
                            <div class="col-md-3">
                                <input type="text" class="form-control" required name="email" placeholder="No Kip">
                            </div>
                        </div>
	...
	<div class="row footer">
		<div class="col-md-12" >
    		<p class="text-center">Created By Kelompok 8</p>
    	</div>
    </div>
</div>
</body>
